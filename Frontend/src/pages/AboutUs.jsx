    ...
    <div className="mt-20">
      <div className="text-white min-h-screen p-6 md:p-12 transition-all duration-700 ease-in-out">
        ...
        <section className="max-w-5xl mx-auto mt-16 transition duration-700 ease-in-out hover:scale-[1.01]">
          <h2 className="text-black dark:text-white text-4xl font-extrabold mb-8 border-b-4 inline-block border-secondary pb-1">
            Mission & Vision
          </h2>
        ...
        <section className="max-w-5xl mx-auto mt-20">
          <h2 className="text-black dark:text-white text-4xl font-extrabold mb-12 border-b-4 inline-block border-secondary pb-1">
            Meet the Team
          </h2>
          {loading ? (

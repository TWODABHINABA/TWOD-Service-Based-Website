        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            {services.map((service, index) => (
              <motion.div
                key={index}
                className="relative flex flex-col items-center text-center p-6 rounded-2xl w-full h-[150px] bg-white/10 dark:bg-black/20 shadow-xl backdrop-blur-md overflow-hidden hover:shadow-2xl transition-all border-black dark:border-white"
              ...
              >
                ...
                <h3 className="font-semibold text-xl text-red-700 mb-10">{service.name}</h3>
                {/* <p className="text-sm text-black dark:text-gray-400 mb-10">{service.description}</p> */}

            ...
            {testimonialData.map((item, index) => (
              <div key={index}>
                <div
                  ...
                  className="bg-black  border-4 border-black dark:border-white rounded-2xl m-4 p-6 my-10 relative shadow-[0_4px_24px_0_rgba(255,255,255,0.5)]"
                >
                    ...
                    <div className="clint-card-details">
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="text-sm text-white">{item.profession}</p>
                        </div>

    ...
    <section className="mt-20">
      ...
      >
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-gray-800 dark:text-gray-400">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-5 py-3 text-base font-medium rounded-lg focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-700 bg-black text-white hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200 transition-colors"
          >
            <button className="btn-github flex items-center gap-2">
